...
- Highest-maintenance files by line count:
  - `client/src/features/admin/settings-page.tsx` - 4,723 lines after extracting settings sub-tabs
  ...
  - `client/src/features/admin/cms/builder/block-renderer.tsx` - 1,664 lines after extracting the CMS block icon registry, core content blocks, and conversion blocks
