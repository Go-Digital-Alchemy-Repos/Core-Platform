...
const demoListings: DemoListing[] = [
  ...
  },
  {
    ...
    bio: "Demo therapist profile for relocation stress, grief, couples counseling, and family transitions.",
    specializations: ["Family Therapy", "Grief & Loss", "Expatriate Adjustment"],
    languages: ["English", "French", "Swahili"],
    credentials: "MA Marriage and Family Therapy, LMFT",
  ...
  },
  {
    ...
    bio: "Demo counselor profile for trauma-informed care, mindfulness, depression, and bicultural identity.",
    specializations: ["Trauma & PTSD", "Depression", "Mindfulness"],
    languages: ["English", "Spanish"],
    credentials: "MS Clinical Mental Health Counseling, LPC",
