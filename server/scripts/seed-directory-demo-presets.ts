...
const demoListings: DemoListing[] = [
  ...
  },
  {
    ...
    bio: "Demo provider profile for cross-cultural identity, anxiety support, belonging, and globally mobile families.",
    specializations: ["Anxiety", "Identity & Belonging", "Cross-Cultural Transitions"],
    languages: ["English", "Mandarin"],
    credentials: "PhD Cross-Cultural Support, Certified Support Professional",
