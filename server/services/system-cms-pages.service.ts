...
export async function ensureSystemCmsPages() {
  ...
  if (!existingPrivacyPolicy) {
    await storage.cmsPages.createPage({
      ...
      seoTitle: "Privacy Policy | TCK Wellness",
      seoDescription: "Review the TCK Wellness privacy policy and how personal information is collected, used, and protected.",
      seoKeywords: "privacy policy, data privacy, TCK Wellness privacy",
      ogImageUrl: "",
      canonicalUrl: "",
      noindex: false,
      publishedAt: new Date(),
