...
describe("ecommerce fraud service", () => {
  ...
  it("defaults billing and shipping mismatches to manual review", async () => {
    ...
    const result = await evaluateEcommerceFraud({
      ...
      shippingAddress: { address: "1 Home St", city: "Detroit", state: "MI", zip: "48201", country: "US" },
      billingAddress: { address: "2 Billing St", city: "Detroit", state: "MI", zip: "48201", country: "US" },
    });
