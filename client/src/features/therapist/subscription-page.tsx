...
export default function SubscriptionPage() {
  ...
  const retryPaymentMutation = useMutation({
    ...
    onSuccess: async () => {
      ...
      toast({
        ...
        description: "Stripe is retrying your latest renewal payment now.",
      });
    },
    onError: (error: Error) => {
  ...
  const isApprovedForSubscription =
      ...
      <div className="p-6 space-y-6 max-w-4xl mx-auto">
        ...
        {subscription?.status === "past_due" && (
          <Alert>
            ...
            <AlertDescription>
              Your latest renewal charge did not go through. Please update your billing details and
              retry the payment within the grace window to avoid suspension.
            </AlertDescription>
          </Alert>
        )}
        ...
        {subscription?.status === "suspended" && (
          <Alert variant="destructive">
            ...
            <AlertDescription>
              Your {directorySettings.directoryLabelSingular.toLowerCase()} listing is currently
              suspended because the renewal payment is still unresolved. Update billing and retry
              the payment to restore access.
            </AlertDescription>
          </Alert>
        )}
        ...
        {!isApprovedForSubscription && (
          <Alert data-testid="alert-subscription-gated">
            ...
            <AlertDescription className="space-y-3">
              <p>
                Membership subscriptions are available after your application has been approved.
