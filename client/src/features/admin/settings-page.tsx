...
export const INTEGRATIONS: IntegrationConfig[] = [
  {
    ...
    capabilities: ["Cards", "Wallets", "Subscriptions", "Payment Element", "Refund API", "Webhooks"],
    supportedCapabilities: ["payment_authorization", "payment_capture", "payment_refund", "payment_void", "payment_dispute_webhook"],
    supportedEvents: ["payment_intent.succeeded", "refund.created", "refund.updated"],
    operational: true,
    ...
    instructions: [
      ...
      "Refunds use Stripe's Refunds API against the original PaymentIntent and refund webhooks reconcile pending, processed, and failed states.",
    ],
  ...
  },
  {
    ...
    supportedCapabilities: ["payment_authorization", "payment_capture", "payment_refund", "payment_void", "payment_dispute_webhook"],
    supportedEvents: ["PAYMENT.CAPTURE.REFUNDED", "PAYMENT.CAPTURE.DENIED", "CUSTOMER.DISPUTE.CREATED"],
    operational: false,
    ...
    instructions: [
      ...
      "Refunds must call PayPal's capture refund API using the original capture ID; Core Platform will not mark PayPal refunds operational until that adapter is implemented.",
    ],
  ...
  },
  {
    ...
    capabilities: ["Payments", "POS", "Locations", "Refund API", "Webhooks"],
    supportedCapabilities: ["payment_authorization", "payment_capture", "payment_refund", "payment_void", "payment_dispute_webhook"],
    supportedEvents: ["refund.updated", "payment.updated", "dispute.created"],
    operational: false,
    requiresAdapter: true,
    ...
    instructions: [
      ...
      "Refunds must call Square's Refunds API with the original payment ID and idempotency key; Core Platform will not mark Square refunds operational until that adapter is implemented.",
    ],
    supportsConnectionTest: false,
    fields: [
      {
  ...
  },
  {
    ...
    libraryCategory: "Payment Gateways",
    capabilities: ["Cards", "Merchant gateway", "Fraud tools", "Refund API", "Webhooks"],
    supportedCapabilities: ["payment_authorization", "payment_capture", "payment_refund", "payment_void", "payment_dispute_webhook"],
    supportedEvents: ["net.authorize.payment.refund.created", "net.authorize.payment.authcapture.created"],
    operational: false,
    requiresAdapter: true,
    ...
    instructions: [
      ...
      "Refunds must call Authorize.net's createTransactionRequest with refundTransaction using the original transaction reference; Core Platform will not mark Authorize.net refunds operational until that adapter is implemented.",
    ],
    supportsConnectionTest: false,
    fields: [
      {
  ...
  },
  {
    ...
    libraryCategory: "Payment Gateways",
    capabilities: ["Cards", "PayPal", "Venmo", "Vaulting", "Wallets", "Refund API"],
    supportedCapabilities: ["payment_authorization", "payment_capture", "payment_refund", "payment_void", "payment_dispute_webhook"],
    supportedEvents: ["transaction_disbursed", "dispute_opened", "dispute_lost", "dispute_won"],
    operational: false,
    requiresAdapter: true,
    ...
    instructions: [
      ...
      "Refunds must call Braintree transaction refund using the original transaction ID; Core Platform will not mark Braintree refunds operational until that adapter is implemented.",
    ],
    supportsConnectionTest: false,
    fields: [
      {
  ...
  },
  {
    ...
    libraryCategory: "Payment Gateways",
    capabilities: ["Cards", "Global payments", "Risk", "Refund API", "Webhooks"],
    supportedCapabilities: ["payment_authorization", "payment_capture", "payment_refund", "payment_void", "payment_dispute_webhook"],
    supportedEvents: ["REFUND", "REFUND_FAILED", "AUTHORISATION", "CANCEL_OR_REFUND"],
    operational: false,
    requiresAdapter: true,
    ...
    instructions: [
      ...
      "Refunds must call Adyen modification/refund APIs with the original PSP reference; Core Platform will not mark Adyen refunds operational until that adapter is implemented.",
    ],
    supportsConnectionTest: false,
    fields: [
      {
  ...
  },
  {
    ...
    libraryCategory: "Payment Gateways",
    capabilities: ["Amazon wallet", "Checkout", "Refund API", "Signing keys"],
    supportedCapabilities: ["payment_authorization", "payment_capture", "payment_refund", "payment_void", "payment_dispute_webhook"],
    supportedEvents: ["Charge.Refunded", "Refund.Initiated", "Refund.Completed", "Refund.Declined"],
    operational: false,
    requiresAdapter: true,
    ...
    instructions: [
      ...
      "Refunds must call Amazon Pay refund APIs against the original charge/capture; Core Platform will not mark Amazon Pay refunds operational until that adapter is implemented.",
    ],
    supportsConnectionTest: false,
    fields: [
      {
  ...
  },
  {
    ...
    libraryCategory: "Payment Gateways",
    capabilities: ["Apple wallet", "Domain verification", "Merchant identity", "Processor refunds"],
    supportedCapabilities: ["wallet_tokenization"],
    operational: false,
    requiresAdapter: true,
    ...
    instructions: [
      ...
      "Apple Pay does not provide a standalone Core Platform refund API; refunds must run through the payment processor that accepted the Apple Pay transaction.",
    ],
    supportsConnectionTest: false,
    fields: [
      {
  ...
  },
  {
    ...
    libraryCategory: "Payment Gateways",
    capabilities: ["Google wallet", "Gateway mapping", "Merchant profile", "Processor refunds"],
    supportedCapabilities: ["wallet_tokenization"],
    operational: false,
    requiresAdapter: true,
    ...
    instructions: [
      ...
      "Google Pay does not provide a standalone Core Platform refund API; refunds must run through the gateway that processed the Google Pay transaction.",
    ],
    supportsConnectionTest: false,
    fields: [
      {
  ...
  },
  {
    ...
    libraryCategory: "Payment Gateways",
    capabilities: ["Buy now pay later", "Order management", "Regional payments", "Refund API"],
    supportedCapabilities: ["payment_authorization", "payment_capture", "payment_refund", "payment_void", "payment_dispute_webhook"],
    supportedEvents: ["order_refunded", "order_cancelled", "capture_refunded"],
    operational: false,
    requiresAdapter: true,
    ...
    instructions: [
      ...
      "Refunds must call Klarna order management refund APIs against the captured order; Core Platform will not mark Klarna refunds operational until that adapter is implemented.",
    ],
    supportsConnectionTest: false,
    fields: [
      {
  ...
  },
  {
    ...
    libraryCategory: "Payment Gateways",
    capabilities: ["Buy now pay later", "Clearpay", "Merchant checkout", "Refund API"],
    supportedCapabilities: ["payment_authorization", "payment_capture", "payment_refund", "payment_void", "payment_dispute_webhook"],
    supportedEvents: ["refund.approved", "refund.declined", "payment.captured"],
    operational: false,
    requiresAdapter: true,
    ...
    instructions: [
      ...
      "Refunds must call Afterpay/Clearpay refund APIs against the original order token or payment reference; Core Platform will not mark Afterpay refunds operational until that adapter is implemented.",
    ],
    supportsConnectionTest: false,
    fields: [
      {
