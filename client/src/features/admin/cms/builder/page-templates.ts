  ...
  },
  {
    ...
    blocks: () => [
      block("section-header", {
        ...
        subtitle: "Expert perspectives on cross-cultural mental health, TCK identity, and global wellness.",
        alignment: "center",
      }),
      ...
      block("cta", {
        ...
        subheading: "Get the latest insights on TCK mental health delivered to your inbox.",
        primaryText: "Subscribe to Newsletter",
        primaryLink: "/newsletter",
        secondaryText: "",
        secondaryLink: "",
        variant: "accent",
      }),
